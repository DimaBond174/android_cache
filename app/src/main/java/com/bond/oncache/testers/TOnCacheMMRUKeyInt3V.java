...
public class TOnCacheMMRUKeyInt3V implements ITester {
  OnCacheMMRUV<IKeyInt3,  IKeyInt3> cache  =  null;
  ...
  public void onStart(int capacity, TJsonToCfg cfg) {
    cache  =  new OnCacheMMRUV<IKeyInt3,  IKeyInt3>(capacity, 10);
  }
