...
import com.bond.oncache.caches.OnCacheMMRUV;
import com.bond.oncache.i.IKeyString;
import com.bond.oncache.i.ITester;
import com.bond.oncache.objs.TJsonToCfg;


public class TOnCacheMMRUKeyStringV implements ITester {
  OnCacheMMRUV<IKeyString,  IKeyString> cache  =  null;
  ...
  public void onStart(int capacity, TJsonToCfg cfg) {
    cache  =  new OnCacheMMRUV<IKeyString,  IKeyString>(capacity, 10);
  }
